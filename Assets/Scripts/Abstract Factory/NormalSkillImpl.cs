...
namespace AbstractFactory {
    public class MysticShot : QSkillHandler {
        public MysticShot(Character character) : base(character) { }
    ...
    public class EssenceFlux : WSkillHandler {
        public EssenceFlux(Character character) : base(character) { }
    ...
    public class ArcaneShift : ESkillHandler {
        public ArcaneShift(Character character) : base(character) { }
    ...
    {
        public Glitterlance(Character character) : base(character) { }
    ...
    public class Whimsy : WSkillHandler {
        public Whimsy(Character character) : base(character) { }
    ...
    public class HelpPix : ESkillHandler {
        public HelpPix(Character character) : base(character) { }
